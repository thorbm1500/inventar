...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/account/[id]" | "/(app)/browse" | "/(app)/inventory" | "/(app)/inventory/[id]" | "/(app)/inventory/[id]/settings" | "/(app)/inventory/new" | "/(app)/projects" | "/(app)/settings"
