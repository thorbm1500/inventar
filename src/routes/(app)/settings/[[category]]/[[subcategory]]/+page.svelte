<script lang="ts">
    ...
    import {capitalizeFirstLetter} from "$lib/util/utilities";
    ...
    import SelectOption from "$lib/components/settings/SelectOption.svelte";
    import InputOption from "$lib/components/settings/InputOption.svelte";
    import ToggleOption from "$lib/components/settings/ToggleOption.svelte";
...
<section class="inventory-settings-page">
    ...
    <div class="settings-container">
        {#if currentView.category === 'general' && currentView.subcategory === 'basics' }
            ...
            <InputOption bind:title={locale.settings.general.basics.application_id} value={applicationSettings.general.basics.application_id} readonly={true}/>
            <div class="custom-option-subtitle">
            ...
            <SelectOption bind:title={locale.settings.general.basics.language} bind:value={applicationSettings.general.basics.language} values={AVAILABLE_LOCALES}/>
            <InputOption bind:title={locale.settings.general.basics.data_directory} value="/etc/inventar/data" readonly={true}/>
            <InputOption bind:title={locale.settings.general.basics.data_directory} value="/etc/inventar/logs" readonly={true}/>
            <SelectOption bind:title={locale.settings.general.basics.log_level} bind:value={applicationSettings.general.basics.log_level} values={['Debug','Info','Warning','Error']}
        ...
        {#if currentView.category === 'general' && currentView.subcategory === 'mail' }
            ...
            <InputOption name="mail_host" id="mail_host" bind:title={locale.settings.general.mail.host} bind:value={applicationSettings.general.mail.host} placeholder="smtp.inventar.dev"/>
            <InputOption type="number" name="mail_port" id="mail_port" bind:title={locale.settings.general.mail.port} bind:value={applicationSettings.general.mail.port} placeholder="587"/>
            <div class="custom-option-subtitle">
                <h3>{locale.settings.general.mail.port_description}.</h3>
            </div>
            <InputOption name="mail_user" id="mail_user" bind:title={locale.settings.general.mail.user} bind:value={applicationSettings.general.mail.user} placeholder="inventar"/>
            <InputOption type="password" name="mail_password" id="mail_password" bind:title={locale.settings.general.mail.password} bind:value={applicationSettings.general.mail.password}
                         placeholder="Enter Password..."/>
            <InputOption name="mail_sender_mail" id="mail_sender_mail" bind:title={locale.settings.general.mail.sender_mail} bind:value={applicationSettings.general.mail.sender_mail}
                         placeholder="inventar@prodzeus.dev"/>
            <InputOption name="mail_sender_name" id="mail_sender_name" bind:title={locale.settings.general.mail.sender_name} bind:value={applicationSettings.general.mail.sender_name}
                         placeholder="zeus"/>
            <div class="custom-option-subtitle">
        ...
        {#if currentView.category === 'security' && currentView.subcategory === 'general' }
            ...
            <ToggleOption bind:title={locale.settings.security.general.allow_registration} bind:value={applicationSettings.security.general.allow_registration}/>
            <div class="custom-option-subtitle">
                <h3>{locale.settings.security.general.allow_registration_description}.</h3>
            </div>
            <ToggleOption bind:title={locale.settings.security.general.require_registration_token} bind:value={applicationSettings.security.general.require_token}/>
            <div class="custom-option-subtitle">
        ...
        {#if currentView.category === 'security' && currentView.subcategory === 'privacy' }
            ...
            <ToggleOption title={locale.settings.security.privacy.enable_telemetry} bind:value={applicationSettings.security.privacy.telemetry_enable}/>
            <div class="custom-option-subtitle">
                <h3>{locale.settings.security.privacy.enable_telemetry_description}.</h3>
            </div>
            <ToggleOption title={locale.settings.security.privacy.instance_identifier} value={true} readonly={true}/>
            <div class="custom-option-subtitle">
            ...
            <ToggleOption title={locale.settings.security.privacy.telemetry_options_country} bind:value={applicationSettings.security.privacy.telemetry_country}
                          readonly={!applicationSettings.security.privacy.telemetry_enable}/>
            <ToggleOption title={locale.settings.security.privacy.telemetry_options_region} bind:value={applicationSettings.security.privacy.telemetry_region}
                          readonly={!applicationSettings.security.privacy.telemetry_enable}/>
            <ToggleOption title={locale.settings.security.privacy.telemetry_options_inventories} bind:value={applicationSettings.security.privacy.telemetry_inventories}
                          readonly={!applicationSettings.security.privacy.telemetry_enable}/>
            <ToggleOption title={locale.settings.security.privacy.telemetry_options_unique_items} bind:value={applicationSettings.security.privacy.telemetry_unique_items}
                          readonly={!applicationSettings.security.privacy.telemetry_enable}/>
            <ToggleOption title={locale.settings.security.privacy.telemetry_options_total_items} bind:value={applicationSettings.security.privacy.telemetry_total_items}
                          readonly={!applicationSettings.security.privacy.telemetry_enable}/>
        {/if}
