<script lang="ts">
    ...
    const userSettings: UserSettings = $derived(ContextHandler.getUserSettings());
    ...
    onMount(() => {
        ...
        document.addEventListener('click', (event: MouseEvent) => {
            if (event.target instanceof HTMLElement) {
                ...
                if (id.includes('pill') || id.includes('sidebar')) {
                    return;
                }

                const parentId = element.parentElement?.id;
                if (parentId && (parentId.includes('pill') || parentId.includes('sidebar'))) {
                    return;
                }
...
<section class="offline-pill {isOnline ? 'online' : 'offline'}">
    {locale.generics.browser_offline}
...
<section id="sidebar" class="sidebar {sidebar?'open':'closed'}">
    <div class="top-section">
        <a id="pill-action" data-sveltekit-preload-code="hover" href="/">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a id="pill-action" data-sveltekit-preload-code="hover" href="/browse">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a id="pill-action" data-sveltekit-preload-code="hover" href="/settings">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.0005 15C13.6573 15 15.0005 13.6569 15.0005 12C15.0005 10.3431 13.6573 9 12.0005 9C10.3436 9 9.00049 10.3431 9.00049 12C9.00049 13.6569 10.3436 15 12.0005 15Z"
                      stroke="currentColor"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"/>
    ...
    <div class="user-actions">
        ...
        <a id="pill-action" class="action profile" title="Profile" data-sveltekit-preload-code="hover" href="/account/{user.uuid}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a id="pill-action" class="action logout" title="Logout" data-sveltekit-reload href="/logout">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style>
    * {
    ...
    .sidebar {
        ...
        background: rgba(from var(--theme-background-sidebar) r g b / .95);
        backdrop-filter: blur(3px) brightness(1.35);
