...
<div class="account-tooltip" id="account-tooltip"
    ...
    <button class="blue-hover" type="button" title="Settings" style="transform:translateX(.15rem);" onclick="{() => window.location.href = '/settings'}">
...
<section class="sidebar-section {sidebar?'open':'closed'} visible md:invisible flex md:hidden">
    ...
    <div class="bottom-buttons">
        <button class="theme-switch-button" id="dark-light-mode-switcher" onclick={toggleTheme} title="Switch Theme">
            {#if theme === 'dark'}
